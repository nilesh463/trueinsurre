...
//    }
    ...
    public SecurityFilterChain filterChain(HttpSecurity http,
        ...
        http.csrf().disable()
            .authorizeRequests()
            .requestMatchers("/login/**","/delete-profile","/request-delete", "/confirm-delete","/api/auth/**","/sidebar","/password-request","/password-request/**","/reset-password","/reset-password/**","/admin/**", "/images/**","draft/**","/css/**","js/**","/video/**","/opt/javaProjects/ibsInvoice/images/").permitAll()
.anyRequest().authenticated()
            .and()
            .formLogin().loginPage("/login").successHandler(successHandler)
            .and()
